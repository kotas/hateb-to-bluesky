// This file is a fork version of `unfurl.js` to run on Cloudflare Workers
...
function getRemoteMetadata(url: string, opts: Opts) {
  return async function ({ oembed, metadata }: any) {
    if (!oembed) {
      return metadata;
    }
...
function parse(url: string) {
  return function (metadata: [string, string | string[]][]) {
    // eslint-disable-next-line
    const parsed: any = {};
    const ogVideoTags: (string | string[])[] = [];
